...
WS_MODE_CHANNELS = 1
WS_MODE_CHUNK_DURATION_MS = 320.0

WEBRTC_MODE_INPUT_SAMPLE_RATE = 48000
WEBRTC_MODE_OUTPUT_SAMPLE_RATE = 48000
WEBRTC_MODE_CHANNELS = 1
WEBRTC_MODE_CHUNK_DURATION_MS = 320.0

EOF_SILENCE_DURATION_S = 10.0

OUT_SYSINFO_SUFFIX = ".sysinfo.json"
OUT_CONFIG_SUFFIX = ".config.json"
OUT_EXTRA_CONFIG_SUFFIX = ".extra_config.json"
OUT_RUN_RESULT_SUFFIX = ".run_result.json"
OUT_LOG_SUFFIX = ".log"
OUT_TRACE_SUFFIX = ".trace.log"
OUT_IN_AUDIO_SUFFIX = ".in.wav"
OUT_OUT_AUDIO_SUFFIX = ".out.wav"
OUT_REPORT_SUFFIX = ".report.txt"
